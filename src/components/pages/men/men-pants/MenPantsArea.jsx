...
const MenPantsArea = () => {
    ...
    const fetchProducts = async () => {
        ...
        const cached = sessionStorage.getItem("men_pants_products");
        if (cached) {
        ...
        try {
            ...
            if (res.data?.success) {
                const menPants = res.data.data.filter(
                    (p) =>
                ...
                sessionStorage.setItem("men_pants_products", JSON.stringify(menPants));
            } else {
