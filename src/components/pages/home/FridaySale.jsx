...
const FridaySale = () => {
  ...
  const [currentIndex, setCurrentIndex] = useState(0); // Add state for render
    ...
    const slide = () => {
      ...
      gsap.timeline({
        ...
        onComplete: () => {
          ...
          setCurrentIndex(nextIndex); // Update state for render
  ...
  const goToPrevSlide = () => {
    ...
    gsap.timeline({
      ...
      onComplete: () => {
        ...
        setCurrentIndex(prevIndex); // Update state for render
        isAnimating.current = false;
      },
    })
      .to(imgA, { xPercent: 100 })
            ...
            {SALE_IMAGES.map((_, idx) => (
              <button
                ...
                onClick={() => {
                  ...
                  if (targetIndex !== currentIdx && !isAnimating.current) {
