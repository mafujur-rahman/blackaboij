...
const CategoryTab = ({ category, isActive, onClick }) => {
  ...
  return (
    <button
      onClick={onClick}
      className={`pb-1 text-lg font-medium tracking-[0.2em] uppercase text-center  text-black `}
    >
      {formattedName}
    </button>
  );
  ...
  return (
    <div className="mt-12.5 mb-12.5 xl:mb-25">
      <div className="px-4 lg:px-12 xl:px-24 2xl:px-48">
        <h1 className="text-lg font-bold tracking-[0.2em] uppercase text-center  text-black">Hot Sale</h1>
